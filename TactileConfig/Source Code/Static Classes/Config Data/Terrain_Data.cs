            ...
            { 0, new Dictionary<Vector2, Vector2>
                {
                    ...
                    { new Vector2(8, 25), new Vector2(8, 28) },
                    { new Vector2(8, 26), new Vector2(8, 29) },
                    { new Vector2(8, 27), new Vector2(8, 30) },
                    { new Vector2(9, 25), new Vector2(9, 28) },
                    { new Vector2(9, 26), new Vector2(9, 29) },
                    { new Vector2(9, 27), new Vector2(9, 30) },
                    { new Vector2(10, 25), new Vector2(10, 28) },
                    { new Vector2(10, 26), new Vector2(10, 29) },
                    { new Vector2(10, 27), new Vector2(10, 30) },
                    { new Vector2(11, 25), new Vector2(8, 28) },
                    { new Vector2(11, 26), new Vector2(11, 28) },
                    { new Vector2(11, 27), new Vector2(11, 30) },
                    { new Vector2(12, 25), new Vector2(12, 28) },
                    { new Vector2(12, 26), new Vector2(12, 29) },
                    { new Vector2(12, 27), new Vector2(12, 30) },
                    { new Vector2(11, 29), new Vector2(10, 29) },
                    { new Vector2(14, 30), new Vector2(12, 29) },
                    { new Vector2(0, 1), new Vector2(11, 30) }
                }
            },
            #endregion
